        ...
        Html(
          ...
          customRenders: {
            tagMatcher('img'):
              ...
              if (document.Content!.Images?[url] != null) {
                tempImage = document.Content!.Images![url]!.Content!;
              } else {
                tempImage =
                    document.Content!.Images!.entries.first.value.Content ?? [];
              }

              return Image(
                image: MemoryImage(
                  Uint8List.fromList(tempImage),
                ),
              );
            }),
          },
